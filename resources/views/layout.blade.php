...
<body>
                    ...
                    <div class="col-sm-6">
                        <div class="contactinfo">
                            <ul class="nav nav-pills">
                                <li><a href="#"><i class="fa fa-phone"></i> +84 0329849797</a></li>
                                <li><a href="https://mail.google.com/mail/u/0/#inbox"><i class="fa fa-envelope"></i> shopgp@gmail.com</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-sm-6">
                    ...
                    <div class="col-sm-7">
                        ...
                        <div class="mainmenu pull-left">
                            <ul class="nav navbar-nav collapse navbar-collapse">
                                ...
                                <li class="dropdown"><a href="#">Sản phẩm</a></li> 
    ...
    <footer id="footer"><!--Footer-->
        ...
        <div class="footer-bottom">
            <div class="container">
                <div class="row">
                    <p class="pull-left">Copyright © 2020 Shopgp.vn. All rights reserved.</p>
                    <p class="pull-right">Designed by <span><a target="_blank" href="http:shopgp.vn">Shopgp.vn</a></span></p>
                </div>
            </div>
        </div>
