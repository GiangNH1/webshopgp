...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th9 05, 2020 lúc 06:16 PM
...
(1, 'admin@gmail.com', '21232f297a57a5a743894a0e4a801fc3', 'Hồng Giang', '0329849797', NULL, NULL);
...
(2, 'China', 'China', 'Nơi cung cấp tất cả mặt hàng về áo thun nam', 0, NULL, NULL),
(3, 'Thailand', 'Thai-Lan', 'Nơi cung cấp tất cả mặt hàng', 0, NULL, NULL),
(4, 'Việt Nam', 'Viet-Nam', 'Nới sản xuất các mặt hàng uy tín chất lượng mẫu mã đẹp', 0, NULL, NULL);
...
(4, 'Áo thun nam', 'Ao-thun-nam', 'Vãi mềm mại, mặt thoáng mát thoải mái', 0, NULL, NULL),
(5, 'Áo thun nữ', 'Ao-thun-nu', 'Áo phong cách thời trang, luôn là xu hướng ', 0, NULL, NULL),
(6, 'Áo sơ mi nam', 'Ao-so-mi-nam', 'Áo phong cách thời trang, luôn là xu hướng ', 0, NULL, NULL);
...
(5, 'Giang', 'user@gmail.com', 'ee11cbb19052e40b07aac0ca060c23ee', '0329849797', NULL, NULL);
...
(4, 'Áo thun nam vải lưới', 'Ao-thun-nam-vai-luoi', 4, 2, 'Shop hiện đang có các mẫu áo thun thương hiệu hàng xuất dư VNXK dành cho các bro đây!! Hàng VNXK không phải bàn cãi về chất vải cũng như form dáng rồi ạ.', 'Shop hiện đang có các mẫu áo thun thương hiệu hàng xuất dư VNXK dành cho các bro đây!! Hàng VNXK không phải bàn cãi về chất vải cũng như form dáng rồi ạ.', '99000', 'aothun10.jpg', 0, NULL, NULL),
(5, 'Áo thun nữ cao cấp', 'Ao-thun-nu-cao-cap', 5, 2, 'Shop hiện đang có các mẫu áo thun thương hiệu hàng xuất dư VNXK dành cho các bro đây!! Hàng VNXK không phải bàn cãi về chất vải cũng như form dáng rồi ạ.', 'Shop hiện đang có các mẫu áo thun thương hiệu hàng xuất dư VNXK dành cho các bro đây!! Hàng VNXK không phải bàn cãi về chất vải cũng như form dáng rồi ạ.', '59000', 'aothunnu178.jpg', 0, NULL, NULL),
(6, 'Áo sơ mi nam vãi trơn', 'Ao-so-mi-nam-vai-tron', 6, 4, 'Shop hiện đang có các mẫu áo thun thương hiệu hàng xuất dư VNXK dành cho các bro đây!! Hàng VNXK không phải bàn cãi về chất vải cũng như form dáng rồi ạ.', 'Shop hiện đang có các mẫu áo thun thương hiệu hàng xuất dư VNXK dành cho các bro đây!! Hàng VNXK không phải bàn cãi về chất vải cũng như form dáng rồi ạ.', '110000', 'sominam261.jpg', 0, NULL, NULL);
...
(7, 'Giang', 'Quảng Ngãi', '0329849797', 'nguyenhonggiang51@gmail.com', 'abc', NULL, NULL);
